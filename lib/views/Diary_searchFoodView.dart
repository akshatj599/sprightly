                                ...
                                physics: BouncingScrollPhysics(),
                                  ...
                                  itemBuilder: (context, index) {
                                    return (index != 0 && index != 1)
                                        ? GestureDetector(
                                            onTap: () {
                                                Navigator.push(context, MaterialPageRoute(builder: (context) => ShowFoodDetailsView(index-2, initialItems)));
                                              },
                                            child: Container(
  ...
  Future getPostFoodDetails(BuildContext context) async {
    ...
    if (response.statusCode == 200) {
      ...
      for (int i = 0; i < initialItems.length; i++) {
        ...
        String currItemName = capitalizeEachWord(currItemMap['description'], true);
        String currItemCal =
